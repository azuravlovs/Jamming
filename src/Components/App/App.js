...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playlistTracks: [
        {name: 'PLTName1', artist: 'PLTArtist1', album: 'PLTAlbum1', id: 4}, {name: 'PLTName2', artist: 'PLTArtist2', album: 'PLTAlbum2', id: 5}, {name: 'PLTName3', artist: 'PLTArtist3', album: 'PLTAlbum3', id: 6}
      ]
    }
  }
